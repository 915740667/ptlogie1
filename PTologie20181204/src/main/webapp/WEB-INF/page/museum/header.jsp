    ...
    <div class="m-head">
      ...
      <div class="info">
        ...
        <div class="user">
          ...
          <ul class="folding">
            <a href="javascript:void(0);" onclick="test()"><i class="xiugai"></i><span>修改密码</span></a>
 	...
 	function subarea(){
 		...
 		window.location.href="${webPath}/user/userList";
			...
			function alarm(){
 			window.location.href="${webPath}/alarm/alarmList";
			...
			function changepwd(){
	 			window.location.href="${webPath}/loginUser/changepwd";
