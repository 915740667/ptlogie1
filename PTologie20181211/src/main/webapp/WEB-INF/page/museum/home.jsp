...
<%--   <jsp:include page="header.jsp" flush="true" /> --%>
 ...
 /*  setInterval("dataInfo()",2000);   */
  ...
  //获取实时数据
   	function dataInfo() {
  		 $.ajax({
		        url: "${webPath}/dataInfo/dataInfoList",
		        ...
		        success: function(data) {
		            ...
		            var Lists=data
		             for(var k in Lists) {
		            	    str += "<tr><td>1</td><td>" + Lists[k].sceneName + "</td><td>" + Lists[k].equipmentName + "</td><td>" 
		            ...
		            var Lists=data
		             ...
		             for(var k in Lists) {
		            	 var sceneId=Lists[k].sceneId;
		            	    ...
		            	    +Lists[k].articleName+"</span></li><li><i>一周告警次数</i><span class='num'>"+Lists[k].errorCount+"</span></li></div><a class='ft' href='#' onclick='areaInfo(${sceneId})'> "+"<span>监控信息</span><i>"+"</i></a></div>";
		            }  
     ...
     function confirmPP(){
     	var userform=document.getElementById("userform")
     	 ...
     	 userform.action="${webPath}/equipment/add";
     	 userform.submit();
       } 
